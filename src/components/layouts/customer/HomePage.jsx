    ...
    <div className="!min-h-screen !flex !flex-col !bg-gradient-to-br !from-[#EEF5FF] !to-[#B4D4FF] !text-slate-800">
      ...
      <nav className="!sticky !top-0 !z-50 !bg-[#EEF5FF] !border-b !border-[#B4D4FF] backdrop-blur-md">
        <div className="!mx-auto !max-w-6xl !px-6 !py-4 !flex !items-center !justify-between">
          <button
            onClick={() => navigate("/")}
            className="!text-2xl !font-bold !tracking-wide !text-[#176B87] hover:!opacity-80 !transition"
          >
            🎢 ThemePark
          </button>
          ...
          {!user ? (
            <div className="!space-x-3">
              <Link
                to="/login"
                className="!inline-block !px-4 !py-2 !rounded-lg !font-semibold !bg-white !text-[#176B87] !border !border-[#176B87] hover:!bg-[#EEF5FF] !transition !no-underline"
              >
                Login
              </Link>
              <Link
      ...
      <header className="!flex-1 !flex !items-center !justify-center !text-center !px-6">
        <div className="!max-w-3xl !p-10 !bg-white/60 !rounded-2xl backdrop-blur-md !shadow-lg">
          ...
          <button
            ...
            className="!px-6 !py-3 !bg-[#176B87] !text-white !font-bold !rounded-lg !shadow-md hover:!opacity-90 !transition !border-none"
          >
            Get Tickets
          </button>
        </div>
